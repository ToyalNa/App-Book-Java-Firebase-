...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.HolderComment> {
    ...
    private void deleteComment(ModelComment modelComment, HolderComment holder) {
        ...
        builder.setTitle(R.string.delete_comment)
                .setMessage(R.string.are_you_sure_you_want_to_delete_this_comment)
        ...
        ref.child(uid)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        try {
                            Glide.with(context).load(profileimage).placeholder(R.drawable.ic_person).into(holder.profileTv);
                        }
                        catch (Exception e){
                            holder.profileTv.setImageResource(R.drawable.ic_person);
                        }
                    }
